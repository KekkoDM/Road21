...
struct Tips {
    ...
    let tipsList: [TipsModel] = [
        ...
        TipsModel(title:"Choose organic foods when possible", description: "There are a gazillion health, environmental and social reasons to choose organic foods, so we’ll let that more detailed post linked do the talking and just remind you to choose organic foods whenever possible. They better for your health, the environment, and the farmworkers growing your food."),
        TipsModel(title:"Smile often", description: "Smiling boosts your physical and mental health, so find ways to smile as often as you can throughout the day."),
        TipsModel(title:"Work on overcoming your fears", description: "Fears hold us back and keep us from living life as our best self. Acknowledge your fears and take steps to overcome them."),
        TipsModel(title:"Use a yoga ball as a desk chair", description: "Save your back/shoulders/neck and strengthen your core by using a yoga ball as a desk chair."),
        TipsModel(title:"Manage stress with self\n care activities", description: "Chronic stress is detrimental to both your physical and mental health. Get to know your stress triggers (the things that cause stress for you, either quickly or in the long-term) as well as your stress releases (the things that can help calm you when you’re stressed) so you can proactively cope with stress and maintain healthy levels."),
        TipsModel(title:"Practice gratitude", description: "Practice gratitude each day—this could be when you wake up, before bed, or during your lunch break at work."),
        TipsModel(title:"Limit sugary drinks", description: "Sugary drinks like sodas, fruit juices, and sweetened teas are the primary source of added sugar in the American diet"),
        TipsModel(title:"Eat nuts and seeds", description: "Some people avoid nuts because they are high in fat. However, nuts and seeds are incredibly nutritious. They are packed with protein, fiber, and a variety of vitamins and minerals"),
        TipsModel(title:"Eat fatty fish", description: "Fish is a great source of high-quality protein and healthy fat. This is particularly true of fatty fish, such as salmon, which is loaded with anti-inflammatory omega-3 fatty acids and various other nutrients"),
        TipsModel(title:"Avoid bright lights before sleep", description: "When you’re exposed to bright lights — which contain blue light wavelengths — in the evening, it may disrupt your production of the sleep hormone melatonin"),
        TipsModel(title:"Meditate", description: "Stress has a negative effect on your health. It can affect your blood sugar levels, food choices, susceptibility to sickness, weight, fat distribution, and more. For this reason, it’s important to find healthy ways to manage your stress. Meditation is one such way, and it has some scientific evidence to support its use for stress management and improving health"),
        TipsModel(title:"Floss your teeth", description: "Floss your teeth daily for good dental health and overall health. Not only does flossing daily protect your teeth and gums, but good dental health is also important for immunity and heart health.")
    ]
}
